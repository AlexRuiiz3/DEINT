...
namespace CRUD_Personas_Dal.Gestora
{
    public class GestoraPersonasDAL
    {
        ...
        /// Postcondiciones: Se insertara en la tabla Persona de una base de datos una persona, si la persona recibida esta a null o se produce alguna excepcion no se insertara la 
        ...
        /// <summary>
        /// Cabecera: public static int eliminarPersona(int idPersona)
